...
import { cancelSessionAPI, fetchSessionsByUserAPI } from '../../services/userService';
 ...
 const [cancelSessionId,setCancelSessionId]=useState<string | null>(null)
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800 dark:text-white">My Sessions</h1>
            ...
            <div className="flex items-center space-x-3">
              <div>
                <h4 className="text-lg font-semibold text-gray-800">
                    ...
                    You will get refund only if you cancel three days prior to the sheduled session.
               </h4>
